...
function validate(values) {
  return {
    ...
    shopName: runValidators(values.shopName, required('Hospital name')),
  };
}
...
export default function Settings() {
  ...
  const avatarLetter = (values.email?.[0] || 'H').toUpperCase();
          ...
          <>
            ...
            <div className="mb-6 flex items-center gap-4">
              ...
              <div>
                ...
                {uploading && (
                  <p className="mt-1 text-xs text-ink-400">Uploading…</p>
                )}
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <label className="block">
                <span className={labelCls}>🏥 Hospital name</span>
                <input
                  className={inputCls}
