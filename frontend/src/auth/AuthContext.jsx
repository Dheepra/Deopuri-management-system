...
// Sliding-session tuning. Token lives 1 hour on the backend; while the user is active we
// swap it for a fresh one well before it expires, and after some idle time we let the
// session lapse and bounce to login.
const IDLE_LIMIT_MS = 30 * 60 * 1000;   // no activity for this long -> logout
const REFRESH_EVERY_MS = 45 * 60 * 1000; // while active, refresh the token this often
const CHECK_EVERY_MS = 60 * 1000;        // how often we evaluate idle / refresh
